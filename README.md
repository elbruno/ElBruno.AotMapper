...
|---------|-------|-----------|-------------|
| **ElBruno.AotMapper** | [![NuGet](https://img.shields.io/nuget/v/ElBruno.AotMapper.svg?style=flat-square)](https://www.nuget.org/packages/ElBruno.AotMapper) | [![Downloads](https://img.shields.io/nuget/dt/ElBruno.AotMapper.svg?style=flat-square&color=informational)](https://www.nuget.org/packages/ElBruno.AotMapper) | Core attributes and abstractions |
| **ElBruno.AotMapper.Generator** | [![NuGet](https://img.shields.io/nuget/v/ElBruno.AotMapper.Generator.svg?style=flat-square)](https://www.nuget.org/packages/ElBruno.AotMapper.Generator) | [![Downloads](https://img.shields.io/nuget/dt/ElBruno.AotMapper.Generator.svg?style=flat-square&color=informational)](https://www.nuget.org/packages/ElBruno.AotMapper.Generator) | Roslyn incremental source generator (dev dependency) |
| **ElBruno.AotMapper.AspNetCore** | [![NuGet](https://img.shields.io/nuget/v/ElBruno.AotMapper.AspNetCore.svg?style=flat-square)](https://www.nuget.org/packages/ElBruno.AotMapper.AspNetCore) | [![Downloads](https://img.shields.io/nuget/dt/ElBruno.AotMapper.AspNetCore.svg?style=flat-square&color=informational)](https://www.nuget.org/packages/ElBruno.AotMapper.AspNetCore) | DI registration and ASP.NET Core extensions |
| **ElBruno.AotMapper.EntityFramework** | [![NuGet](https://img.shields.io/nuget/v/ElBruno.AotMapper.EntityFramework.svg?style=flat-square)](https://www.nuget.org/packages/ElBruno.AotMapper.EntityFramework) | [![Downloads](https://img.shields.io/nuget/dt/ElBruno.AotMapper.EntityFramework.svg?style=flat-square&color=informational)](https://www.nuget.org/packages/ElBruno.AotMapper.EntityFramework) | EF Core integration and projection helpers |
